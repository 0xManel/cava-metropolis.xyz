#!/usr/bin/env python3
"""
Importa localizaciones manuales de SPA (-1) Cava 3 para:
...
SOURCE_CSV_PATH = ROOT / "reports" / "spa_cava3_manual_source.csv"
REPORT_JSON_PATH = ROOT / "reports" / "spa_cava3_import_report.json"
REPORT_UNMATCHED_CSV_PATH = ROOT / "reports" / "spa_cava3_import_unmatched.csv"
...
MANUAL_ROWS = [
    ("Sancerre", None, 1, "3·A·D"),
    ("Springfield Methode Ancienne Chardonnay", 2020, 1, "3·A·D"),
    ("Chateau Romassan Rose", 2024, 1, "3·A·D"),
    ("Source of Joy", 2024, 1, "3·B·D"),
    ("Doniene Gorrondona Bizkaiko Txakolina", None, 1, "3·C·D"),
    ("Raats Old Vine Chenin Blanc", 2023, 1, "3·C·D"),
    ("Dialectica de los Opuestos", None, 1, "3·C·D"),
    ("Flor de Albihar Rico Nuevo", None, 1, "3·D·D"),
    ("Cantocuerdas Albillo Bernabeleva", None, 1, "3·D·D"),
    ("Ponce Blanco Seleccion", None, 1, "3·D·D"),
    ("Puro Rofe Morro La Virgen Masdache", 2023, 1, "3·E·D"),
    ("La Lume", 2022, 1, "3·E·D"),
    ("Bermejo Malvasia Blanco", 2024, 1, "3·E·D"),
    ("Vidonia Suertes del Marques", 2024, 1, "3·E·A"),
    ("Finca Trasdairelas Godello Joaquin Rebolledo", None, 1, "3·F·D"),
    ("Gran Vino Pazo Barrantes Albarino", 2022, 1, "3·F·D"),
    ("Chivite Coleccion 125 Gran Vino Blanco", 2023, 1, "3·G·D"),
    ("Whispering Angel", None, 1, "3·G·D"),
    ("Chateau d Esclans Cotes de Provence Rose", 2024, 1, "3·G·D"),
    ("Penas Aladas Clarete Dominio del Aguila", 2020, 1, "3·G·D"),
    ("Motor Blanc 4 Kilos", None, 1, "3·G·D"),
    ("Primer Blanc Marques de Murrieta", 2024, 1, "3·G·D"),
    ("Flor de Muga", 2023, 1, "3·H·D"),
    ("Storm Chardonnay", 2023, 1, "3·H·D"),
    ("Ratpenat Celler Credo", 2021, 1, "3·H·A"),
    ("Pouilly Fume MCMLV La Vigne de 1955 Domaine du Bouchot", 2022, 1, "3·H·A"),
    ("Savage White", 2023, 1, "3·H·A"),
    ("Primer Rose Marques de Murrieta", 2024, 1, "3·BASE"),
    ("Sancerre", None, 1, "3·BASE"),
    ("DeMorgenzon Reserve Chenin Blanc", 2022, 1, "3·BASE"),
    ("Chateau Peyrassol Rose", None, 1, "3·BASE"),
    ("Villapanes Emilio Hidalgo", None, 1, "3·BASE"),
    ("La Panesa Emilio Hidalgo", None, 1, "3·BASE"),
    ("El Tresillo Emilio Hidalgo", None, 1, "3·BASE"),
    ("Kumeu River Mates Vineyard Chardonnay", 2023, 1, "3·BASE"),
    ("Niepoort Vintage Port", 2022, 1, "3·BASE"),
    ("Graham 10 Year Old Tawny Port", None, 1, "3·BASE"),
    ("Don PX Cosecha Toro Albala", 2023, 1, "3·BASE"),
]


CURATED_POD_BY_SOURCE = {
    "sancerre": "POD019375",
    "springfield methode ancienne chardonnay": "POD015864",
    "chateau romassan rose": "POD016970",
    "source of joy": "POD019733",
    "doniene gorrondona bizkaiko txakolina": "POD012988",
    "raats old vine chenin blanc": "POD018207",
    "flor de albihar rico nuevo": "POD019638",
    "cantocuerdas albillo bernabeleva": "POD019778",
    "ponce blanco seleccion": "POD019465",
    "puro rofe morro la virgen masdache": "POD019729",
    "la lume": "POD018377",
    "vidonia suertes del marques": "POD019470",
    "finca trasdairelas godello joaquin rebolledo": "POD018412",
    "gran vino pazo barrantes albarino": "POD018331",
    "chivite coleccion 125 gran vino blanco": "POD018568",
    "whispering angel": "POD017306",
    "chateau d esclans cotes de provence rose": "POD017306",
    "penas aladas clarete dominio del aguila": "POD014007",
    "motor blanc 4 kilos": "POD019726",
    "flor de muga": "POD018644",
    "storm chardonnay": "POD018073",
    "ratpenat celler credo": "POD019722",
    "pouilly fume mcmlv la vigne de 1955 domaine du bouchot": "POD019763",
    "savage white": "POD018291",
    "primer rose marques de murrieta": "POD012772",
    "chateau peyrassol rose": "POD017633",
    "villapanes emilio hidalgo": "POD016046",
    "la panesa emilio hidalgo": "POD016043",
    "el tresillo emilio hidalgo": "POD016047",
    "kumeu river mates vineyard chardonnay": "POD016733",
    "demorgenzon reserve chenin blanc": "POD018206",
    "niepoort vintage port": "POD013279",
    "graham 10 year old tawny port": "POD019785",
    "don px cosecha toro albala": "POD019615",
}
...
def main() -> None:
    ...
    report = {
        ...
        "location_convention": "3·<BALDA>·A (atrás) | 3·<BALDA>·D (frente) | 3·BASE",
