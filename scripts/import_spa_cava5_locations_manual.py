#!/usr/bin/env python3
"""
Importa localizaciones manuales de SPA (-1) Cava 5 (espumosos) para:
...
SOURCE_CSV_PATH = ROOT / "reports" / "spa_cava5_manual_source.csv"
REPORT_JSON_PATH = ROOT / "reports" / "spa_cava5_import_report.json"
REPORT_UNMATCHED_CSV_PATH = ROOT / "reports" / "spa_cava5_import_unmatched.csv"
...
MANUAL_ROWS = [
    ("Cristal Brut Louis Roederer", None, 3, "5·A·A"),
    ("Collection 246 Louis Roederer", None, 2, "5·A·A"),
    ("Cristal Rose Louis Roederer", 2014, 1, "5·A·D"),
    ("Les Perrieres Brut Nature Moutard", None, 1, "5·A·D"),
    ("Sir Winston Churchill Pol Roger", 2018, 1, "5·A·D"),
    ("La Colline Inspiree Jacques Lassaigne", None, 2, "5·A·D"),
    ("Larmandier Bernier", None, 1, "5·B·A"),
    ("Tarlant", None, 1, "5·B·A"),
    ("Longitude Premier Cru Larmandier Bernier", None, 2, "5·B·D"),
    ("Tradition Extra Brut Laherte Freres", None, 1, "5·C·A"),
    ("Petit Meslier Extra Brut Laherte Freres", None, 1, "5·C·A"),
    ("Krug Grande Cuvee 170", None, 1, "5·C·A"),
    ("Krug Grande Cuvee 171", None, 1, "5·C·A"),
    ("Selosse V O", None, 2, "5·C·D"),
    ("Trois Clochers Leclerc Briant", None, 1, "5·C·D"),
    ("Blanc de Meuniers Leclerc Briant", 2018, 1, "5·C·D"),
    ("Krug Grande Cuvee 173", None, 1, "5·C·D"),
    ("Andre Heucq Hommage Meunier", None, 2, "5·D·A"),
    ("Andre Heucq Brut Nature", 2012, 1, "5·D·A"),
    ("Benoit Lahaye Blanc de Noirs", None, 1, "5·D·A"),
    ("Jacquesson 747", None, 1, "5·D·D"),
    ("Bereche Rive Gauche", 2015, 1, "5·D·D"),
    ("Bereche Brut Reserve", None, 1, "5·D·D"),
    ("Clos Sainte Sophie Jacques Lassaigne", 2013, 2, "5·E·A"),
    ("Bollinger Special Cuvee", None, 1, "5·E·D"),
    ("Pierre Peters L Esprit", 2020, 2, "5·E·D"),
    ("Selosse Rose", None, 2, "5·F·A"),
    ("Dom Ruinart Rose", 2009, 1, "5·F·D"),
    ("Krug Rose", None, 2, "5·F·D"),
    ("Billecart Salmon Rose", None, 1, "5·F·D"),
    ("Christophe Mignon", None, 1, "5·F·D"),
    ("Gosset Grande Reserve", None, 7, "5·BASE"),
    ("Billecart Salmon Le Reserve", None, 2, "5·BASE"),
    ("Raventos i Blanc", None, 1, "5·BASE"),
    ("Andre Heucq Heritage", None, 1, "5·BASE"),
]


CURATED_POD_BY_SOURCE = {
    "cristal brut louis roederer": "POD018554",
    "collection 246 louis roederer": "POD012837",
    "cristal rose louis roederer": "POD012107",
    "les perrieres brut nature moutard": "POD018727",
    "sir winston churchill pol roger": "POD019694",
    "la colline inspiree jacques lassaigne": "POD008371",
    "longitude premier cru larmandier bernier": "POD013155",
    "tradition extra brut laherte freres": "POD013154",
    "petit meslier extra brut laherte freres": "POD016735",
    "krug grande cuvee 170": "POD002086",
    "krug grande cuvee 171": "POD002086",
    "krug grande cuvee 173": "POD002086",
    "selosse v o": "POD004851",
    "trois clochers leclerc briant": "POD017666",
    "blanc de meuniers leclerc briant": "POD_TEMP_1036",
    "andre heucq hommage meunier": "POD010183",
    "bereche brut reserve": "POD004085",
    "pierre peters l esprit": "POD019002",
    "selosse rose": "POD002128",
    "andre heucq heritage": "POD010182",
    "larmandier bernier": "POD013155",
    "andre heucq brut nature": "POD010183",
    "bereche rive gauche": "POD019077",
    "clos sainte sophie jacques lassaigne": "POD019070",
    "raventos i blanc": "POD017361",
}
...
def main() -> None:
    ...
    report = {
        ...
        "location_convention": "5·<BALDA>·A (atrás) | 5·<BALDA>·D (frente) | 5·BASE",
