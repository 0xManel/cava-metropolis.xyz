#!/usr/bin/env python3
"""
Importa localizaciones manuales de SPA (-1) Cava 2 para:
...
SOURCE_CSV_PATH = ROOT / "reports" / "spa_cava2_manual_source.csv"
REPORT_JSON_PATH = ROOT / "reports" / "spa_cava2_import_report.json"
REPORT_UNMATCHED_CSV_PATH = ROOT / "reports" / "spa_cava2_import_unmatched.csv"
...
MANUAL_ROWS = [
    ("Capficat Celler Credo", 2019, 1, "2·A·D"),
    ("Salix Mas Doix", 2024, 1, "2·A·D"),
    ("Salix Mas Doix", 2023, 1, "2·A·D"),
    ("Electio Karel Lo", 2022, 1, "2·A·D"),
    ("Pedra de Guix Terroir al Limit", 2022, 1, "2·A·A"),
    ("Remelluri Blanco", 2022, 1, "2·B·D"),
    ("Roda I Blanco", 2021, 1, "2·B·D"),
    ("Remelluri Blanco", 2021, 1, "2·B·A"),
    ("Roda I Blanco", 2021, 1, "2·B·A"),
    ("Capellania Marques de Murrieta", 2019, 1, "2·C·D"),
    ("Finca La Medina Verdejo Jose Pariente", 2024, 1, "2·D·D"),
    ("La Medina Verdejo Jose Pariente", 2024, 1, "2·D·D"),
    ("Albillo Vinas Viejas Dominio del Aguila", 2020, 1, "2·D·D"),
    ("Capitel Ossian", 2022, 1, "2·D·D"),
    ("Mandolas Oremus", 2022, 1, "2·E·D"),
    ("Mandolas Oremus", 2023, 1, "2·E·D"),
    ("Las Vidres Alvaro Palacios", 2020, 1, "2·E·D"),
    ("Malvasia Roman San Roman", 2022, 1, "2·E·A"),
    ("Belondrade y Lurton", 2024, 1, "2·F·D"),
    ("Belondrade y Lurton", 2023, 1, "2·F·D"),
    ("Abadia Retuerta Le Domaine Blanco de Guarda", 2018, 1, "2·G·A"),
    ("La Lume", 2023, 1, "2·G·D"),
    ("Las Suertes Old Vines", 2024, 1, "2·G·D"),
    ("Flor de Muga", 2022, 1, "2·G·D"),
    ("Mauro Godello", 2024, 1, "2·H·A"),
    ("O Soro Rafael Palacios", 2022, 1, "2·H·A"),
    ("La Salvacion Rafael Palacios", 2023, 1, "2·H·D"),
    ("As Sortes Rafael Palacios", 2023, 1, "2·H·D"),
    ("As Sortes Rafael Palacios", 2024, 1, "2·H·D"),
    ("Avancia Godello", 2024, 1, "2·H·D"),
    ("Attis Mar", None, 1, "2·I·A"),
    ("Pazo de Senorans Ilustracion de Anada", 2015, 1, "2·I·A"),
    ("Attis Lias Finas Albarino", 2024, 1, "2·I·D"),
    ("Attis Corribante Varietales", 2022, 1, "2·I·D"),
    ("Attis Embajador Albarino", None, 1, "2·BASE"),
    ("Oremus Mandolas Furmint", 2022, 1, "2·BASE"),
    ("La Mision", None, 1, "2·BASE"),
    ("Jose Pariente Albarino", 2020, 1, "2·BASE"),
    ("La Comtesse Albarino", 2020, 1, "2·BASE"),
    ("Hattenfeld Spanier Riesling", 2024, 1, "2·BASE"),
    ("As Sortes Rafael Palacios", 2024, 1, "2·BASE"),
]


CURATED_POD_BY_SOURCE = {
    "capficat celler credo": "POD019721",
    "salix mas doix": "POD016307",
    "electio karel lo": "POD012985",
    "pedra de guix terroir al limit": "POD018590",
    "remelluri blanco": "POD018620",
    "roda i blanco": "POD015771",
    "capellania marques de murrieta": "POD018339",
    "finca la medina verdejo jose pariente": "POD015910",
    "la medina verdejo jose pariente": "POD015910",
    "albillo vinas viejas dominio del aguila": "POD012203",
    "capitel ossian": "POD018123",
    "mandolas oremus": "POD013541",
    "las vidres alvaro palacios": "POD019641",
    "malvasia roman san roman": "POD016116",
    "belondrade y lurton": "POD016481",
    "abadia retuerta le domaine blanco de guarda": "POD015923",
    "la lume": "POD018377",
    "las suertes old vines": "POD018588",
    "flor de muga": "POD018643",
    "mauro godello": "POD018907",
    "o soro rafael palacios": "POD012358",
    "la salvacion rafael palacios": "POD017705",
    "as sortes rafael palacios": "POD018997",
    "avancia godello": "POD018578",
    "attis mar": "POD018753",
    "pazo de senorans ilustracion de anada": "POD017626",
    "attis lias finas albarino": "POD017771",
    "attis corribante varietales": "POD016566",
    "attis embajador albarino": "POD015306",
    "oremus mandolas furmint": "POD013541",
    "la mision": "POD018268",
    "la comtesse albarino": "POD018333",
    "hattenfeld spanier riesling": "POD019397",
}
...
def main() -> None:
    ...
    report = {
        ...
        "location_convention": "2·<BALDA>·A (atrás) | 2·<BALDA>·D (frente) | 2·BASE",
